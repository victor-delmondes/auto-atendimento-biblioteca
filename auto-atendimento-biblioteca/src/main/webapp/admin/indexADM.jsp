        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="/deletelivro" method="post"><input type="hidden" id="modal-idLivroDelete" name="id">
                        <button class="btn btn-primary" type="submit" style="background: var(--bs-red);border-color: var(--bs-red);">Sim</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="modal-editar">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-light" type="button" data-bs-dismiss="modal">Fechar</button>
                    <button class="btn btn-primary" type="button" onclick="submitForm()" style="background: rgb(2,72,115);border-color: rgb(2,72,115);">Salvar</button>
                </div>
            </div>
        </div>
    </div>
