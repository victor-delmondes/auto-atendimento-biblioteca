...
<body class="bg-gradient-primary" style="background: rgb(2,72,115);">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form action="/aluguel-confirm" method="post" id="emprestimoForm">
                                                    <input type="date" name="dataDevolucao" id="datadev" style="height: 50px;width: 220px;text-align: center;" min="" max="">
    ...
    <script>
        //trava o seletor de data pra alugar por no maximo 30 dias
        const hoje = new Date();
        document.getElementById('datadev').max = new Date(hoje.setDate(hoje.getDate()+30)).toISOString().split('T')[0];
    </script>
</body>
