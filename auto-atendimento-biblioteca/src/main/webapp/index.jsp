            ...
            <nav class="navbar navbar-expand bg-white shadow mb-4 topbar">
                <div class="container-fluid">
                    <form class="d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search" method="get" action="index">
                        <div class="input-group"><input class="bg-light form-control border-0 small" type="text" placeholder="Pesquisar" name="pesquisa">
                            <button class="btn btn-primary py-0" type="submit" style="background: rgb(2,72,115);"><i class="fas fa-search"></i></button>
                        </div>
                    </form>
                    <c:if test="${sessionScope.user != null}">
                        <div>
                                ...
                                <a href="#" class="text-decoration-none"
                                   ...
                                   data-location="${livro.location}">
                                    <div class="card" style="text-align: center;">
                                        <div class="card-body">
                                            <h4 class="card-title" style="height: 60px; align-items: center; justify-content: center; text-align: center; display: flex">${livro.titulo}</h4>
