                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="/register" method="post">
                                <div class="row mb-3" style="padding-left: 0px;margin-left: 0px;margin-right: 0px;"><input class="form-control form-control-user" type="text" id="nomeinput" placeholder="Nome completo" name="nome" style="width: 636px;"></div>
                                <div class="row mb-3">
